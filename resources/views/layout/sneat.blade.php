...
>
  ...
  <body>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="/img/avatar.jpg" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Saputra</span>
    ...
    <script>
      const buttonConfirm = document.querySelectorAll('.confirmdelete');
      for( let i = 0; i < buttonConfirm.length; i++){
        $(buttonConfirm[i]).on('click', function (e) {
            e.preventDefault();
