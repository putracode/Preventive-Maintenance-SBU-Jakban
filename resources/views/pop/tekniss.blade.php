    ...
    @if (!empty($recti) && !empty($battere))
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Recti & Battere</h3>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form action="/pop/teknis/recti" method="POST">
                        @csrf
                        <input type="hidden" name="pop_id" value="{{ $pop_id }}">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="number" class="form-control recti_ke" id="recti_ke" name="recti_ke" value="1">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group mb-4">
                                        <label for="merk">Merk</label>
                                        <input type="number" class="form-control merk" id="merk" name="merk">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-4">
                                        <label for="kapasitas">Kapasitas (A)</label>
                                        <input type="number" class="form-control kapasitas" id="kapasitas" name="kapasitas">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group mb-4">
                                        <label for="beban">Beban</label>
                                        <input type="number" class="form-control beban" id="beban" name="beban">
                                    </div>
                                </div>
                            </div>
                            @foreach ($allBattere as $row)
                                @if ($row->bank_ke == 1)
                                    <div class="form-group mb-4">
                                        <label for="bank_ke">Bank Ke</label>
                                        <input type="number" class="form-control bank_ke" id="bank_ke" name="bank_ke">
                                    </div>
                                @endif
                            @endforeach
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="number" class="form-control type" id="type" name="type">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group mb-4">
                                        <label for="kapasitas">Kapasitas (AH)</label>
                                        <input type="number" class="form-control kapasitas" id="kapasitas" name="kapasitas" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group mb-4">
                                        <label for="hasil_uji">Hasil Uji (AH)</label>
                                        <input type="number" class="form-control hasil_uji" id="hasil_uji" name="hasil_uji">
                                    </div>
                                </div>
                            </div>
